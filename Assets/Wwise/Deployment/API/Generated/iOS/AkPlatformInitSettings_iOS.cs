...
public class AkPlatformInitSettings : IDisposable {
  ...
  public AudioSessionCategory eAudioSessionCategory {
    set {
      AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_eAudioSessionCategory_set(swigCPtr, (int)value);

    } 
    get {
      AudioSessionCategory ret = (AudioSessionCategory)AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_eAudioSessionCategory_get(swigCPtr);
  ...
  public uint uMaxSuspendTimeoutMs {
    set {
      AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_uMaxSuspendTimeoutMs_set(swigCPtr, value);

    } 
    get {
      uint ret = AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_uMaxSuspendTimeoutMs_get(swigCPtr);
