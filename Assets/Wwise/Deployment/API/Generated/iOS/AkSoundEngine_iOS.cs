...
public class AkSoundEngine {
  ...
  public static AKRESULT ListenToAudioSessionInterruption(bool in_bEnterInterruption) {
    AKRESULT ret = (AKRESULT)AkSoundEnginePINVOKE.CSharp_ListenToAudioSessionInterruption(in_bEnterInterruption);

    return ret;
  }

  public static AKRESULT Suspend() {
    AKRESULT ret = (AKRESULT)AkSoundEnginePINVOKE.CSharp_Suspend();
